...
pub async fn pins_add(configuration: &configuration::Configuration, token: &str, channel: &str, timestamp: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<PinsAddError>> {
...
pub async fn pins_remove(configuration: &configuration::Configuration, token: &str, channel: &str, timestamp: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<PinsRemoveError>> {

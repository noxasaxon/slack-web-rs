...
pub async fn reactions_add(configuration: &configuration::Configuration, token: &str, channel: &str, name: &str, timestamp: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsAddError>> {
...
pub async fn reactions_list(configuration: &configuration::Configuration, token: &str, user: Option<&str>, full: Option<bool>, count: Option<i32>, page: Option<i32>, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsListError>> {
...
pub async fn reactions_remove(configuration: &configuration::Configuration, token: &str, name: &str, file: Option<&str>, file_comment: Option<&str>, channel: Option<&str>, timestamp: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsRemoveError>> {

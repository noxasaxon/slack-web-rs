...
pub async fn team_access_logs(configuration: &configuration::Configuration, token: &str, before: Option<&str>, count: Option<&str>, page: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamAccessLogsError>> {
...
pub async fn team_integration_logs(configuration: &configuration::Configuration, token: &str, app_id: Option<&str>, change_type: Option<&str>, count: Option<&str>, page: Option<&str>, service_id: Option<&str>, user: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamIntegrationLogsError>> {

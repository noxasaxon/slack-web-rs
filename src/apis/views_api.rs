...
pub async fn views_update(configuration: &configuration::Configuration, token: &str, view_id: Option<&str>, external_id: Option<&str>, view: Option<&str>, hash: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ViewsUpdateError>> {

...
pub async fn search_messages(configuration: &configuration::Configuration, token: &str, query: &str, count: Option<i32>, highlight: Option<bool>, page: Option<i32>, sort: Option<&str>, sort_dir: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<SearchMessagesError>> {

...
pub async fn admin_apps_approved_list(configuration: &configuration::Configuration, token: &str, limit: Option<i32>, cursor: Option<&str>, team_id: Option<&str>, enterprise_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsApprovedListError>> {
...
pub async fn admin_apps_requests_list(configuration: &configuration::Configuration, token: &str, limit: Option<i32>, cursor: Option<&str>, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsRequestsListError>> {
...
pub async fn admin_apps_restricted_list(configuration: &configuration::Configuration, token: &str, limit: Option<i32>, cursor: Option<&str>, team_id: Option<&str>, enterprise_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsRestrictedListError>> {
...
pub async fn admin_conversations_ekm_list_original_connected_channel_info(configuration: &configuration::Configuration, token: &str, channel_ids: Option<&str>, team_ids: Option<&str>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminConversationsEkmListOriginalConnectedChannelInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.conversations.ekm.listOriginalConnectedChannelInfo", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_conversations_restrict_access_add_group(configuration: &configuration::Configuration, token: &str, group_id: &str, channel_id: &str, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminConversationsRestrictAccessAddGroupError>> {
    ...
    let local_var_uri_str = format!("{}/admin.conversations.restrictAccess.addGroup", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_conversations_restrict_access_list_groups(configuration: &configuration::Configuration, token: &str, channel_id: &str, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminConversationsRestrictAccessListGroupsError>> {
    ...
    let local_var_uri_str = format!("{}/admin.conversations.restrictAccess.listGroups", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_conversations_restrict_access_remove_group(configuration: &configuration::Configuration, token: &str, team_id: &str, group_id: &str, channel_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminConversationsRestrictAccessRemoveGroupError>> {
    ...
    let local_var_uri_str = format!("{}/admin.conversations.restrictAccess.removeGroup", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_invite_requests_approved_list(configuration: &configuration::Configuration, token: &str, team_id: Option<&str>, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminInviteRequestsApprovedListError>> {
...
pub async fn admin_invite_requests_denied_list(configuration: &configuration::Configuration, token: &str, team_id: Option<&str>, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminInviteRequestsDeniedListError>> {
...
pub async fn admin_teams_admins_list(configuration: &configuration::Configuration, token: &str, team_id: &str, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsAdminsListError>> {
...
pub async fn admin_teams_owners_list(configuration: &configuration::Configuration, token: &str, team_id: &str, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsOwnersListError>> {
...
pub async fn admin_teams_settings_set_default_channels(configuration: &configuration::Configuration, token: &str, team_id: &str, channel_ids: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetDefaultChannelsError>> {

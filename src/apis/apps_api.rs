...
pub async fn apps_event_authorizations_list(configuration: &configuration::Configuration, token: &str, event_context: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsEventAuthorizationsListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.event.authorizations.list", configuration.base_path);
...
pub async fn apps_permissions_request(configuration: &configuration::Configuration, token: &str, scopes: &str, trigger_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsRequestError>> {
...
pub async fn apps_permissions_users_request(configuration: &configuration::Configuration, token: &str, scopes: &str, trigger_id: &str, user: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsUsersRequestError>> {
...
pub async fn apps_uninstall(configuration: &configuration::Configuration, token: Option<&str>, client_id: Option<&str>, client_secret: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsUninstallError>> {

...
pub async fn conversations_create(configuration: &configuration::Configuration, token: Option<&str>, name: Option<&str>, is_private: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsCreateError>> {
...
pub async fn conversations_history(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, latest: Option<f32>, oldest: Option<f32>, inclusive: Option<bool>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsHistoryError>> {
...
pub async fn conversations_info(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, include_locale: Option<bool>, include_num_members: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsInfoError>> {
...
pub async fn conversations_invite(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, users: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsInviteError>> {
...
pub async fn conversations_kick(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, user: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsKickError>> {
...
pub async fn conversations_list(configuration: &configuration::Configuration, token: Option<&str>, exclude_archived: Option<bool>, types: Option<&str>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsListError>> {
...
pub async fn conversations_mark(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, ts: Option<f32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsMarkError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.mark", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_members(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsMembersError>> {
...
pub async fn conversations_open(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, users: Option<&str>, return_im: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsOpenError>> {
...
pub async fn conversations_rename(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, name: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsRenameError>> {
...
pub async fn conversations_replies(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, ts: Option<f32>, latest: Option<f32>, oldest: Option<f32>, inclusive: Option<bool>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsRepliesError>> {
...
pub async fn conversations_set_purpose(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, purpose: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsSetPurposeError>> {
...
pub async fn conversations_set_topic(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, topic: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsSetTopicError>> {

...
pub async fn workflows_step_completed(configuration: &configuration::Configuration, token: &str, workflow_step_execute_id: &str, outputs: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<WorkflowsStepCompletedError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/workflows.stepCompleted", configuration.base_path);
...
pub async fn workflows_step_failed(configuration: &configuration::Configuration, token: &str, workflow_step_execute_id: &str, error: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<WorkflowsStepFailedError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/workflows.stepFailed", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn workflows_update_step(configuration: &configuration::Configuration, token: &str, workflow_step_edit_id: &str, inputs: Option<&str>, outputs: Option<&str>, step_name: Option<&str>, step_image_url: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<WorkflowsUpdateStepError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/workflows.updateStep", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());

...
pub async fn files_info(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, count: Option<&str>, page: Option<&str>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesInfoError>> {
...
pub async fn files_list(configuration: &configuration::Configuration, token: Option<&str>, user: Option<&str>, channel: Option<&str>, ts_from: Option<f32>, ts_to: Option<f32>, types: Option<&str>, count: Option<&str>, page: Option<&str>, show_files_hidden_by_limit: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesListError>> {
...
pub async fn files_remote_info(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, external_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteInfoError>> {
...
/// Retrieve information about a remote file added to Slack
pub async fn files_remote_list(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, ts_from: Option<f32>, ts_to: Option<f32>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteListError>> {
...
pub async fn files_remote_remove(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, external_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteRemoveError>> {
...
pub async fn files_remote_share(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>, external_id: Option<&str>, channels: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteShareError>> {

...
/// Deletes a message.
pub async fn chat_delete(configuration: &configuration::Configuration, token: Option<&str>, ts: Option<f32>, channel: Option<&str>, as_user: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatDeleteError>> {
...
pub async fn chat_get_permalink(configuration: &configuration::Configuration, token: &str, channel: &str, message_ts: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatGetPermalinkError>> {
...
pub async fn chat_me_message(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, text: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatMeMessageError>> {
...
pub async fn chat_post_ephemeral(configuration: &configuration::Configuration, token: &str, channel: &str, user: &str, as_user: Option<bool>, attachments: Option<&str>, blocks: Option<&str>, icon_emoji: Option<&str>, icon_url: Option<&str>, link_names: Option<bool>, parse: Option<&str>, text: Option<&str>, thread_ts: Option<&str>, username: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatPostEphemeralError>> {
...
pub async fn chat_scheduled_messages_list(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>, latest: Option<f32>, oldest: Option<f32>, limit: Option<i32>, cursor: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatScheduledMessagesListError>> {
...
pub async fn chat_unfurl(configuration: &configuration::Configuration, token: &str, channel: &str, ts: &str, unfurls: Option<&str>, user_auth_message: Option<&str>, user_auth_required: Option<bool>, user_auth_url: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatUnfurlError>> {
...
/// Updates a message.
pub async fn chat_update(configuration: &configuration::Configuration, token: &str, channel: &str, ts: &str, as_user: Option<&str>, attachments: Option<&str>, blocks: Option<&str>, link_names: Option<&str>, parse: Option<&str>, text: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ChatUpdateError>> {

...
pub async fn oauth_access(configuration: &configuration::Configuration, client_id: Option<&str>, client_secret: Option<&str>, code: Option<&str>, redirect_uri: Option<&str>, single_channel: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<OauthAccessError>> {
...
pub async fn oauth_token(configuration: &configuration::Configuration, client_id: Option<&str>, client_secret: Option<&str>, code: Option<&str>, redirect_uri: Option<&str>, single_channel: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<OauthTokenError>> {

...
/// Ends a Call.
pub async fn calls_end(configuration: &configuration::Configuration, token: &str, id: &str, duration: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<CallsEndError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/calls.end", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn calls_info(configuration: &configuration::Configuration, token: &str, id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<CallsInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/calls.info", configuration.base_path);
...
pub async fn calls_participants_add(configuration: &configuration::Configuration, token: &str, id: &str, users: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<CallsParticipantsAddError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/calls.participants.add", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn calls_participants_remove(configuration: &configuration::Configuration, token: &str, id: &str, users: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<CallsParticipantsRemoveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/calls.participants.remove", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn calls_update(configuration: &configuration::Configuration, token: &str, id: &str, title: Option<&str>, join_url: Option<&str>, desktop_app_join_url: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<CallsUpdateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/calls.update", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());

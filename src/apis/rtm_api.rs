...
pub async fn rtm_connect(configuration: &configuration::Configuration, token: &str, batch_presence_aware: Option<bool>, presence_sub: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<RtmConnectError>> {

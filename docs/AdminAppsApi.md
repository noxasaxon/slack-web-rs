...
> ::std::collections::HashMap<String, serde_json::Value> admin_apps_approve(token, app_id, request_id, team_id)
...
> ::std::collections::HashMap<String, serde_json::Value> admin_apps_restrict(token, app_id, request_id, team_id)
